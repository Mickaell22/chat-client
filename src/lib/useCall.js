...
//
// ponytail: solo STUN (viene de VITE_STUN_URL, sin hardcodear el host), sin
// TURN. Techos: sin STUN configurado solo conecta en la misma red local; y
// dos redes con NAT restrictivo (WiFi corporativo, datos moviles) pueden no
// conectar. Upgrade: agregar un TURN (coturn self-host o pago) a iceServers.
const ICE_CONFIG = {
